...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-sm hover:bg-maroon-dark hover:shadow-md",
        green:
          "bg-secondary text-secondary-foreground shadow-sm hover:bg-green-dark hover:shadow-md",
        outline:
          "border border-border bg-background hover:bg-muted hover:border-primary/40",
        ghost: "hover:bg-muted",
        link: "text-primary underline-offset-4 hover:underline",
        white:
          "bg-white text-maroon shadow-sm hover:bg-white/90 hover:shadow-md",
        gradient:
